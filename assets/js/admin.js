...
const Q1_SCORES = {
  '이원호':  {w:2, s:0, t:0, up:true},   // 금요승점 10 = 우승2 (교류전 LG 준우승 별도)
  '김덕기':  {w:1, s:0, t:1, up:true},   // 금요승점 7 = 우승1+3위1 (교류전 한전 우승 별도)
  '안치국':  {w:1, s:0, t:0, up:false},  // 금요승점 5 = 우승1
  '이미진':  {w:1, s:0, t:0, up:false},  // 금요승점 5 = 우승1
  '최양님':  {w:1, s:0, t:0, up:false},  // 금요승점 5 = 우승1
  '이상건':  {w:0, s:0, t:2, up:false},  // 금요승점 4 = 3위2
  '이진규':  {w:0, s:1, t:0, up:true},   // 금요승점 3 = 준우승1 (교류전 8pt → 총11pt 승급)
  '김영서':  {w:0, s:0, t:1, up:false},  // 금요승점 2 = 3위1
};

// Q1 리그 날짜별 입상 기록 (승점표 순서 기반 매핑)
const Q1_LEAGUE_PLACEMENTS = {
  '이원호':  [{date:'2026-01-23',r:'w'},{date:'2026-02-13',r:'w'}],
  '김덕기':  [{date:'2026-01-16',r:'t'},{date:'2026-01-23',r:'w'}],
  '안치국':  [{date:'2026-03-13',r:'w'}],
  '이미진':  [{date:'2026-02-13',r:'w'}],
  '최양님':  [{date:'2026-02-06',r:'w'}],
  '이상건':  [{date:'2026-02-13',r:'t'},{date:'2026-02-20',r:'t'}],
  '이진규':  [{date:'2026-02-27',r:'s'}],
  '김영서':  [{date:'2026-03-20',r:'t'}],
};
